...
<html><head><title>FILMOTECA - Listado de opiniones sobre pel&iacuteculas</title></head>
<body>
		...
		if(!$resultado){
			...
			if($numeroregistros>0)
			{
				...
				while($fila=mysqli_fetch_array($resultado))
				{
					...
					echo " <b>Fecha y Hora: </b>" . utf8_encode($fila['fechahora']) . 
						" <b>Película: </b>" . utf8_encode($fila['nombre']) .
						"<br>\n<b>Descripción:</b><br>\n" . utf8_encode(nl2br($fila['opinion']));
